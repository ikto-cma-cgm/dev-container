...
Scaffolds a Node.js microservice with package management, Docker, and Backstage integration.

## Purpose

This template generates a Node.js microservice skeleton including:
- npm/yarn project structure
...
This template is consumed via the Backstage Developer Portal. Navigate to **Create → Node.js Service** and fill in the form.
