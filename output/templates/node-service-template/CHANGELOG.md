...
### Added
- Initial template implementation: TypeScript `package.json`, Express application, Docker `Dockerfile`, Backstage `catalog-info.yaml`, TechDocs scaffolding, CI `pipeline.yml`.
