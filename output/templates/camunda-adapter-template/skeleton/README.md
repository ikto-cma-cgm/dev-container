...
This service is a Camunda adapter that connects to the Camunda BPMN platform. Configure your Camunda cluster credentials in `application-local.yaml` and set the BPMN process ID to `${{values.bpmnProcessId}}`.
