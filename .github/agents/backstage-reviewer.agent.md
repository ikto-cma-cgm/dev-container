...
> ⚠️ **spec.domain** : vérifier sa présence quand la hiérarchie Catalog l'exige (Component/System/Resource selon le cas). `system` et `domain` doivent rester cohérents entre les entités produites.
