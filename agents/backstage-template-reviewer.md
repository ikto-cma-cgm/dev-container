---
description: Audits Backstage Golden Path templates against the 19 linter rules and CMA CGM compliance standards. Conversational, explains the "why" before each fix.
mode: agent
tools:
  - codebase
  - read_file
