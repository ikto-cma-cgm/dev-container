---
description: Creates complete, production-ready Backstage Software Templates (Golden Paths) for CMA CGM. Guides through information gathering, generates all skeleton files (code, tests, CI/CD, docs, Backstage wiring).
mode: agent
tools:
  - codebase
  - read_file
